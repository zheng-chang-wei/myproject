...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") org.apache.shiro.mgt.SecurityManager manager) {
		...
		filterChainDefinitionMap.put("/train/**", "anon");
		filterChainDefinitionMap.put("/fault/**", "anon");
		filterChainDefinitionMap.put("/subhealth/**", "anon");
		filterChainDefinitionMap.put("/lifeDoorItem/**", "anon");
		filterChainDefinitionMap.put("/websocket/**", "anon");
		filterChainDefinitionMap.put("/bode/**", "anon");
