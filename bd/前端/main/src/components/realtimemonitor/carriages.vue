<template>
  <section id="carriages">
    <trainGraph v-if="carriages.length>0" :style="{'margin-top':'10px'}" :carriages="carriages" :carriage-span="carriageSpan" @doorChecked="doorChecked" />
    <el-row style="margin-top:10px;margin-left: 2px;color:white">
      <el-col class="example" :span="2.5">
      ...
      <el-col class="example" style="margin-top:4px" :span="2.5">
