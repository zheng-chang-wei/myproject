...
public class SimpleStatisticsServiceImpl implements SimpleStatisticsService {
	...
	@Override
	public List<MonthStatisticsResult> countByMonth(StatisticsParam param) {
	...
	@Override
	public YearStatisticsResult countByYear(StatisticsParam param) {
		List<String> ids = getTrainId(getTrainString(param));
		param.setTrains(ids.toArray(new String[] {}));
	...
	@Override
	public TypeStatisticsResult countByFaultType(StatisticsParam param) {
		List<String> ids = getTrainId(getTrainString(param));
		param.setTrains(ids.toArray(new String[] {}));
	...
	@Override
	public TypeStatisticsResult countBySubhealthType(StatisticsParam param) {
		List<String> ids = getTrainId(getTrainString(param));
		param.setTrains(ids.toArray(new String[] {}));
	...
	@Override
	public TypeStatisticsResult countByTopType(StatisticsParam param) {
		List<String> ids = getTrainId(getTrainString(param));
		param.setTrains(ids.toArray(new String[] {}));
