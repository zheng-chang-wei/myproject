 ...
 * @Created Dec 5, 2019 11:52:34 AM
 * @Description
 *              <p>
 * @Modification
 *               <p>
 ...
 */
@Component("Response-" + SidConstant.CONTROL_COMMAND)
public class BoardControlResponseFactory implements ResponseFactory {
	...
	public SynapsisResponse create(byte[] datas) {
		BoardControlResponseMessage message = new BoardControlResponseMessage();
		message.parse(datas);
		return message;
	}
