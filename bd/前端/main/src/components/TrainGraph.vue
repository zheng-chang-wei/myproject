    ...
    <el-row style="margin-top: 5px;">
      ...
      <el-col id="head" class="head" :span="2">
        <el-col
          id="doorHeadTop"
          class="door"
          :style="doorColor(carriages[0].doors[headDoorLength-1].state)"
        ...
        <el-col
          class="doorWarning doorHeadWarning"
        ...
        />
        <el-col
          class="door doorHeadWarning"
          :style="doorColor(carriages[0].doors[headDoorLength-2].state)"
      ...
      <el-col class="carriageStyle" :span="carriageSpan">
        ...
        <template v-for="(door,index) in carriages[0].doors">
          <el-col
            v-if="index<(carriages[0].doors.length-2)/2"
            :key="door.addr"
            class="door doorTop"
        ...
        <template v-for="(door,index) in carriages[0].doors">
          <el-col
            v-if="index<(carriages[0].doors.length-2)/2"
            :key="1+carriages[0].name+index+1"
            class="doorWarning"
        ...
        <template v-for="(door,index) in carriages[0].doors">
          <el-col
            v-if="index>=(carriages[0].doors.length-2)/2&&index<(carriages[0].doors.length-2)"
            :key="carriages[0].name+index"
            class="doorWarning"
            :style="warningStyle(door.state)"
          />
        </template>
      ...
      <el-col v-for="carriage in carriagesTop" :key="carriage.name" class="carriageStyle" :span="carriageSpan">
        <template>
          ...
          <template v-for="(door,index) in carriage.doors">
            <el-col
              v-if="index<carriage.doors.length/2"
              :key="door.addr"
              class="door doorTop"
              :style="doorStyle(carriage.doors[2*(index+1)-1].state)"
              @click.native="doorChecked(carriage,2*(index+1))"
            >
              {{ 2*(index+1) }}
            </el-col>
          </template>
      ...
      <el-col class="carriageStyle" :span="carriageSpan">
        ...
        <template v-for="(door,index) in carriages[carriages.length-1].doors">
          <el-col
            v-if="index<(carriages[carriages.length-1].doors.length-2)/2"
            :key="door.addr"
            class="door doorTop"
        ...
        <template v-for="(door,index) in carriages[carriages.length-1].doors">
          <el-col
            v-if="index<(carriages[carriages.length-1].doors.length-2)/2"
            :key="1+carriages[carriages.length-1].name+index+1"
            class="doorWarning"
            :style="warningStyle(door.state)"
          />
        </template>
        ...
        <template v-for="(door,index) in carriages[carriages.length-1].doors">
          <el-col
            ...
            :key="carriages[carriages.length-1].name+index"
            class="doorWarning"
            :style="warningStyle(door.state)"
          />
        </template>
      ...
      <el-col id="end" class="head" :span="2">
        ...
        <el-row
          class="doorWarning doorEndWarning"
          :style="warningImg(carriages[0].doors[headDoorLength-1].state,'top')"
        />
