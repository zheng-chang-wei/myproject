CREATE TABLE `t_base_value` (
  `project_id` int(11) NOT NULL,
  `variable` varchar(50) NOT NULL,
  `base_values` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`project_id`,`variable`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE `t_config_variable` (
...
CREATE TABLE `t_door_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL COMMENT '门类型名称',
...
CREATE TABLE `t_effect` (
  ...
  `effect_name` varchar(20) NOT NULL COMMENT '运营影响名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_fault_data` (
  `id` bigint(20) NOT NULL,
  `state` int(11) DEFAULT NULL,
  `key_json` varchar(255) DEFAULT NULL,
  `datas` mediumtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_fault_repair` (
  ...
  PRIMARY KEY (`fault_info_id`,`repair_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `t_fault_solution` (
  `fault_info_id` int(11) NOT NULL,
  `solution_id` int(11) NOT NULL,
  PRIMARY KEY (`fault_info_id`,`solution_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_life_warning` (
  ...
  `debug_mode` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `t_mode` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `mode_name` varchar(20) NOT NULL COMMENT '故障模式名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_stage` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `stage_name` varchar(20) NOT NULL COMMENT '发生阶段名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_subhealth_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `subhealth_info_id` int(11) NOT NULL,
...
CREATE TABLE `t_subhealth_repair` (
  `subhealth_info_id` int(11) NOT NULL,
  `repair_id` int(11) NOT NULL,
  PRIMARY KEY (`subhealth_info_id`,`repair_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `t_subhealth_solution` (
  `subhealth_info_id` int(11) NOT NULL,
  `solution_id` int(11) NOT NULL,
  PRIMARY KEY (`subhealth_info_id`,`solution_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_workdetail` (
  ...
  `door_type_id` int(11) DEFAULT NULL COMMENT '门类型',
  `stage_id` int(11) DEFAULT NULL COMMENT '故障发生阶段',
  `effect_id` int(11) DEFAULT NULL COMMENT '运营影响',
  `mode_id` int(11) DEFAULT NULL COMMENT '故障模式',
  `level_one_id` int(11) DEFAULT NULL,
  `level_two_id` int(11) DEFAULT NULL,
