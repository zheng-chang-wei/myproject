 ...
 * @Created Dec May 19, 2020 8:33:07 PM
 * @Description
 *              <p>
 * @Modification
 *               <p>
 ...
 */
public class ADStorageMessage {

	private ADMessageFileCache cache;
	...
	public ADStorageMessage(long currentPosition) {
		this.currentPosition = currentPosition;
	}

	public void init(String folderPath, String fileName) throws Exception {
		cache = new ADMessageFileCache(true, currentPosition);
		// cache.init(channelID);//TODO
