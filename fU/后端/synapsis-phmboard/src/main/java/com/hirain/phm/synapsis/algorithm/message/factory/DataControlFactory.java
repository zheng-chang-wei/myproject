 ...
 */
@Component("PHM_CONTROL" + SidConstant.PHM_DATACONTROL_COMMAND)
public class DataControlFactory implements ResponseFactory {
	...
	public SynapsisResponse create(byte[] datas) {
		DataControlMessage message = new DataControlMessage();
		message.parse(datas);
		return message;
	}
